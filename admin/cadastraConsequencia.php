...
<head>
    ...
    <script type="text/javascript">
        ...
        function valida(){
            ...
            if (desc.value.trim() == '') {
                alert('Descreva sua consequencia!');
                return false;
            }
            if (desc.value.trim() == '') {

                alert('Selecione um nível para a consequencia!');
                return false;
     ...
     <div class="page-container">
         ...
         <center>
             <div class="col-lg-6" style="margin-top: 10%">
                                <div class="card">
                                    <div class="card-header">Cadastrar Consequência</div>
                                    <div class="card-body card-block">
                                        <form action="/consequencias/cadastraConsequencia.php" method="post" onsubmit="return valida()">
